...
<tr>
	...
	<th width="20%">
		<?php echo JHtml::_('grid.sort', 'COM_ARVIE_PUBLICATIONS_NOM', 'u.nom', $listDirn, $listOrder) ?>
	</th>
	<th width="15%" class="nowrap">
		<?php echo JHtml::_('grid.sort', 'COM_ARVIE_PUBLICATIONS_PRENOM', 'u.prenom', $listDirn, $listOrder) ?>
	</th>
	<th width="20%" class="nowrap">
		<?php echo JHtml::_('grid.sort', 'COM_ARVIE_PUBLICATIONS_EMAIL', 'u.email', $listDirn, $listOrder) ?>
	</th>
