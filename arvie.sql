...
--
-- Hôte : 127.0.0.1
-- Généré le :  jeu. 07 déc. 2017 à 16:44
...
--
-- Structure de la table `arvie_annuaire_civilites`
--

CREATE TABLE `arvie_annuaire_civilites` (
  `id` int(11) NOT NULL,
...
--
-- Déchargement des données de la table `arvie_annuaire_civilites`
--

INSERT INTO `arvie_annuaire_civilites` (`id`, `civilite`, `published`) VALUES
(1, '-', 0),
(2, 'M.', 1),
(3, 'Mme', 1),
(4, 'Mlle', 1);
...
--
-- Structure de la table `arvie_annuaire_contacts`
--

CREATE TABLE `arvie_annuaire_contacts` (
  `id` int(11) NOT NULL,
...
--
-- Déchargement des données de la table `arvie_annuaire_contacts`
--

INSERT INTO `arvie_annuaire_contacts` (`id`, `nom`, `alias`, `prenom`, `civilites_id`, `typescontacts_id`, `entreprises_id`, `fonction`, `email`, `mobile`, `tel`, `commentaire`, `published`, `created`, `created_by`, `modified`, `modified_by`, `hits`) VALUES
(1, '-', '', '', 1, 1, 1, '', '', '', '', '', 0, '2015-12-17 10:57:13', 0, '2017-11-11 19:13:06', 0, 0),
(2, 'DUPONT', 'dupont', 'Pierre', 2, 1, 2, '', '', '', '', '', 1, '2016-03-02 16:15:35', 416, '2017-11-12 16:22:49', 417, 0),
(3, 'SMITH', 'smith', 'Léa', 3, 1, 2, '', '', '', '', '', 1, '2016-03-02 16:16:17', 416, '2017-11-11 19:13:15', 416, 0);

-- --------------------------------------------------------

--
-- Structure de la table `arvie_annuaire_entreprises`
--

CREATE TABLE `arvie_annuaire_entreprises` (
  `id` int(11) NOT NULL,
  `nom` varchar(50) NOT NULL,
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Déchargement des données de la table `arvie_annuaire_entreprises`
--

INSERT INTO `arvie_annuaire_entreprises` (`id`, `nom`, `alias`, `logo`, `activite`, `codeAPE_NAF`, `numSIREN`, `numTVAintra`, `siteWeb`, `tel`, `adrRue`, `adrVille`, `adrCP`, `pays_id`, `commentaire`, `published`, `created`, `created_by`, `modified`, `modified_by`, `hits`) VALUES
(1, '-', '', 'Logo.png', '-', '', '', '', '', '', '', '', '', 1, '', 0, '2015-12-17 10:57:13', 0, '2017-11-11 19:13:06', 416, 0),
(2, 'MonEntreprise', 'monentreprise', 'Logo.png', 'Services numériques', '8299Z', '', '', 'monentreprise.com', '', '', '', '', 2, '', 1, '2016-03-02 16:17:38', 416, '2017-11-12 17:39:27', 416, 0),
(3, 'Sopra-Steria', 'sopra-steria', 'SopraSteria.png', 'Services numériques', '6202A', '', '', 'soprasteria.com', '', '', '', '', 2, '', 1, '2017-11-12 17:32:12', 416, '2017-11-12 17:40:49', 416, 0),
(4, 'Accenture', 'accenture', 'Accenture.png', 'Services numériques', '6202A', '', '', 'accenture.com', '', '', '', '', 2, '', 1, '2017-11-12 17:34:53', 416, '2017-11-12 17:38:19', 416, 0),
(5, 'Carrefour France', 'carrefour-france', 'Carrefour.png', 'Grande distribution', '7010Z', '', '', 'carrefour.fr', '', '', '', '', 2, '', 1, '2017-11-12 17:37:37', 416, '2017-11-12 17:40:31', 416, 0);

-- --------------------------------------------------------

--
-- Structure de la table `arvie_annuaire_pays`
--

CREATE TABLE `arvie_annuaire_pays` (
  `id` int(11) NOT NULL,
...
--
-- Déchargement des données de la table `arvie_annuaire_pays`
--

INSERT INTO `arvie_annuaire_pays` (`id`, `pays`, `published`) VALUES
(1, '-', 0),
(2, 'France', 1),
(3, 'Allemagne', 1),
(4, 'Belgique', 1),
...
--
-- Structure de la table `arvie_annuaire_typescontacts`
--

CREATE TABLE `arvie_annuaire_typescontacts` (
  `id` int(11) NOT NULL,
...
--
-- Déchargement des données de la table `arvie_annuaire_typescontacts`
--

INSERT INTO `arvie_annuaire_typescontacts` (`id`, `typeContact`, `published`) VALUES
(1, '-', 0);
...
--
-- Déchargement des données de la table `arvie_arvie_metiers`
--
...
--
-- Déchargement des données de la table `arvie_arvie_metier_groupe_map`
--
...
INSERT INTO `arvie_arvie_publications` (`id`, `publication_parent`, `groupe`, `auteur`, `titre`, `texte`, `date_publi`, `public`, `alias`, `published`, `created`, `created_by`, `modified`, `modified_by`, `hits`) VALUES
...
--
-- Structure de la table `arvie_assets`
--

CREATE TABLE `arvie_assets` (
...
--
-- Déchargement des données de la table `arvie_assets`
--
...
(18, 1, 53, 90, 1, 'com_modules', 'com_modules', '{\"core.admin\":{\"7\":1}}'),
...
(61, 1, 121, 122, 1, 'com_annuaire', 'com_annuaire', '{\"core.create\":{\"17\":1},\"core.edit\":{\"17\":1},\"core.edit.state\":{\"17\":1},\"core.edit.own\":{\"17\":1}}'),
(62, 16, 48, 49, 2, 'com_menus.menu.2', 'Menu Annuaire', '{}'),
(63, 18, 86, 87, 2, 'com_modules.module.88', 'Annuaire', '{}'),
(64, 18, 88, 89, 2, 'com_modules.module.89', 'Annuaire', '{}'),
(67, 1, 123, 124, 1, 'com_arvie', 'com_arvie', '{}');

-- --------------------------------------------------------

--
-- Structure de la table `arvie_associations`
--

CREATE TABLE `arvie_associations` (
...
--
-- Structure de la table `arvie_banners`
--

CREATE TABLE `arvie_banners` (
  `id` int(11) NOT NULL,
...
--
-- Structure de la table `arvie_banner_clients`
--

CREATE TABLE `arvie_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Structure de la table `arvie_banner_tracks`
--

CREATE TABLE `arvie_banner_tracks` (
...
--
-- Structure de la table `arvie_categories`
--

CREATE TABLE `arvie_categories` (
  `id` int(11) NOT NULL,
...
--
-- Déchargement des données de la table `arvie_categories`
--

INSERT INTO `arvie_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 416, '2017-11-11 08:46:40', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'non-categorise', 'com_content', 'Non catégorisé', 'non-categorise', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 416, '2017-11-11 08:46:40', 0, '0000-00-00 00:00:00', 0, '*', 1),
...
--
-- Structure de la table `arvie_contact_details`
--

CREATE TABLE `arvie_contact_details` (
  `id` int(11) NOT NULL,
...
--
-- Déchargement des données de la table `arvie_contact_details`
--

INSERT INTO `arvie_contact_details` (`id`, `name`, `alias`, `con_position`, `address`, `suburb`, `state`, `country`, `postcode`, `telephone`, `fax`, `misc`, `image`, `email_to`, `default_con`, `published`, `checked_out`, `checked_out_time`, `ordering`, `params`, `user_id`, `catid`, `access`, `mobile`, `webpage`, `sortname1`, `sortname2`, `sortname3`, `language`, `created`, `created_by`, `created_by_alias`, `modified`, `modified_by`, `metakey`, `metadesc`, `metadata`, `featured`, `xreference`, `publish_up`, `publish_down`, `version`, `hits`) VALUES
(1, 'Info ArVie', 'info-arvie', '', '', '', '', '', '', '', '', '', '', '', 0, 1, 0, '0000-00-00 00:00:00', 1, '{\"show_contact_category\":\"\",\"show_contact_list\":\"\",\"presentation_style\":\"\",\"show_tags\":\"\",\"show_info\":\"\",\"show_name\":\"\",\"show_position\":\"\",\"show_email\":\"\",\"add_mailto_link\":\"\",\"show_street_address\":\"\",\"show_suburb\":\"\",\"show_state\":\"\",\"show_postcode\":\"\",\"show_country\":\"\",\"show_telephone\":\"\",\"show_mobile\":\"\",\"show_fax\":\"\",\"show_webpage\":\"\",\"show_image\":\"\",\"show_misc\":\"\",\"allow_vcard\":\"\",\"show_articles\":\"\",\"articles_display_num\":\"\",\"show_profile\":\"\",\"show_links\":\"\",\"linka_name\":\"\",\"linka\":false,\"linkb_name\":\"\",\"linkb\":false,\"linkc_name\":\"\",\"linkc\":false,\"linkd_name\":\"\",\"linkd\":false,\"linke_name\":\"\",\"linke\":false,\"contact_layout\":\"\",\"show_email_form\":\"\",\"show_email_copy\":\"\",\"banned_email\":\"\",\"banned_subject\":\"\",\"banned_text\":\"\",\"validate_session\":\"\",\"custom_reply\":\"\",\"redirect\":\"\"}', 417, 4, 1, '', '', '', '', '', '*', '2017-11-11 09:09:36', 416, '', '2017-11-11 09:09:36', 0, '', '', '{\"robots\":\"\",\"rights\":\"\"}', 0, '', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 2);

-- --------------------------------------------------------

--
-- Structure de la table `arvie_content`
--

CREATE TABLE `arvie_content` (
...
--
-- Déchargement des données de la table `arvie_content`
--
...
--
-- Structure de la table `arvie_contentitem_tag_map`
--

CREATE TABLE `arvie_contentitem_tag_map` (
...
--
-- Structure de la table `arvie_content_frontpage`
--

CREATE TABLE `arvie_content_frontpage` (
...
--
-- Structure de la table `arvie_content_rating`
--

CREATE TABLE `arvie_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Structure de la table `arvie_content_types`
--

CREATE TABLE `arvie_content_types` (
...
--
-- Déchargement des données de la table `arvie_content_types`
--

INSERT INTO `arvie_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Structure de la table `arvie_core_log_searches`
--

CREATE TABLE `arvie_core_log_searches` (
...
--
-- Structure de la table `arvie_extensions`
--

CREATE TABLE `arvie_extensions` (
...
--
-- Déchargement des données de la table `arvie_extensions`
--

INSERT INTO `arvie_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 0, 'LIB_JOOMLA', 'library', 'joomla', '', 0, 1, 1, 1, '{\"name\":\"LIB_JOOMLA\",\"type\":\"library\",\"creationDate\":\"2008\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2017 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"https:\\/\\/www.joomla.org\",\"version\":\"13.1\",\"description\":\"LIB_JOOMLA_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"joomla\"}', '{\"mediaversion\":\"b3e718b87a50a023eaa1d6914942afd2\"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(452, 0, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{\"name\":\"plg_system_updatenotification\",\"type\":\"plugin\",\"creationDate\":\"May 2015\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2017 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.5.0\",\"description\":\"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"updatenotification\"}', '{\"lastrun\":1512651682}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(602, 803, 'French (FR)', 'language', 'fr-FR', '', 0, 1, 0, 0, '{\"name\":\"French (FR)\",\"type\":\"language\",\"creationDate\":\"September 2017\",\"author\":\"French translation team : joomla.fr\",\"copyright\":\"Copyright (C) 2005 - 2017 Open Source Matters. All rights reserved.\",\"authorEmail\":\"traduction@joomla.fr\",\"authorUrl\":\"http:\\/\\/www.joomla.fr\",\"version\":\"3.8.2.1\",\"description\":\"French site language for Joomla 3\",\"group\":\"\"}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(603, 803, 'French (FR)', 'language', 'fr-FR', '', 1, 1, 0, 0, '{\"name\":\"French (FR)\",\"type\":\"language\",\"creationDate\":\"September 2017\",\"author\":\"French translation team : joomla.fr\",\"copyright\":\"Copyright (C) 2005 - 2017 Open Source Matters. All rights reserved.\",\"authorEmail\":\"traduction@joomla.fr\",\"authorUrl\":\"http:\\/\\/www.joomla.fr\",\"version\":\"3.8.2.1\",\"description\":\"French administrator language for Joomla 3\",\"group\":\"\"}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
INSERT INTO `arvie_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
(803, 0, 'French Language pack', 'package', 'pkg_fr-FR', '', 0, 1, 1, 0, '{\"name\":\"French Language pack\",\"type\":\"package\",\"creationDate\":\"07\\/11\\/2017\",\"author\":\"French translation team : joomla.fr\",\"copyright\":\"Copyright (C) 2005 - 2017 Joomla.fr and Open Source Matters, Inc. All rights reserved.\",\"authorEmail\":\"traduction@joomla.fr\",\"authorUrl\":\"http:\\/\\/joomla.fr\",\"version\":\"3.8.2.1\",\"description\":\"<div style=\\\"text-align:left;\\\">\\n<h3>Joomla! 3.8.2 Full French (fr-FR) Language Package - Version 3.8.2.1<\\/h3>\\n<h3>Paquet de langue Joomla! 3.8.2 fran\\u00e7ais (fr-FR) complet - Version 3.8.2.1<\\/h3>\\n<\\/div>\",\"group\":\"\",\"filename\":\"pkg_fr-FR\"}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10000, 0, 'com_annuaire', 'component', 'com_annuaire', '', 1, 1, 0, 0, '{\"name\":\"com_annuaire\",\"type\":\"component\",\"creationDate\":\"March 2016\",\"author\":\"Emmanuel DEROME\",\"copyright\":\"All rights reserved\",\"authorEmail\":\"emmanuel.derome@gmail.com\",\"authorUrl\":\"\",\"version\":\"2.4\",\"description\":\"com_annuaire_descr\",\"group\":\"\",\"filename\":\"annuaire\"}', '{\"show_title\":\"1\",\"link_titles\":\"1\"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(10003, 0, 'com_arvie', 'component', 'com_arvie', '', 1, 1, 0, 0, '{\"name\":\"com_arvie\",\"type\":\"component\",\"creationDate\":\"Novembre 2017\",\"author\":\"Etudiants BTS-SIO2 Louis-Armand Paris\",\"copyright\":\"All rights reserved\",\"authorEmail\":\"\",\"authorUrl\":\"\",\"version\":\"0.6\",\"description\":\"com_arvie_descr\",\"group\":\"\"}', '{}', '', '', 0, '0000-00-00 00:00:00', 0, 0);

-- --------------------------------------------------------

--
-- Structure de la table `arvie_fields`
--

CREATE TABLE `arvie_fields` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Structure de la table `arvie_fields_categories`
--

CREATE TABLE `arvie_fields_categories` (
...
--
-- Structure de la table `arvie_fields_groups`
--

CREATE TABLE `arvie_fields_groups` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `context` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Structure de la table `arvie_fields_values`
--

CREATE TABLE `arvie_fields_values` (
...
--
-- Structure de la table `arvie_finder_filters`
--

CREATE TABLE `arvie_finder_filters` (
...
--
-- Structure de la table `arvie_finder_links`
--

CREATE TABLE `arvie_finder_links` (
...
--
-- Structure de la table `arvie_finder_links_terms0`
--

CREATE TABLE `arvie_finder_links_terms0` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Structure de la table `arvie_finder_links_terms1`
--

CREATE TABLE `arvie_finder_links_terms1` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Structure de la table `arvie_finder_links_terms2`
--

CREATE TABLE `arvie_finder_links_terms2` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Structure de la table `arvie_finder_links_terms3`
--

CREATE TABLE `arvie_finder_links_terms3` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Structure de la table `arvie_finder_links_terms4`
--

CREATE TABLE `arvie_finder_links_terms4` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Structure de la table `arvie_finder_links_terms5`
--

CREATE TABLE `arvie_finder_links_terms5` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Structure de la table `arvie_finder_links_terms6`
--

CREATE TABLE `arvie_finder_links_terms6` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Structure de la table `arvie_finder_links_terms7`
--

CREATE TABLE `arvie_finder_links_terms7` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Structure de la table `arvie_finder_links_terms8`
--

CREATE TABLE `arvie_finder_links_terms8` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Structure de la table `arvie_finder_links_terms9`
--

CREATE TABLE `arvie_finder_links_terms9` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Structure de la table `arvie_finder_links_termsa`
--

CREATE TABLE `arvie_finder_links_termsa` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Structure de la table `arvie_finder_links_termsb`
--

CREATE TABLE `arvie_finder_links_termsb` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Structure de la table `arvie_finder_links_termsc`
--

CREATE TABLE `arvie_finder_links_termsc` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Structure de la table `arvie_finder_links_termsd`
--

CREATE TABLE `arvie_finder_links_termsd` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Structure de la table `arvie_finder_links_termse`
--

CREATE TABLE `arvie_finder_links_termse` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Structure de la table `arvie_finder_links_termsf`
--

CREATE TABLE `arvie_finder_links_termsf` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Structure de la table `arvie_finder_taxonomy`
--

CREATE TABLE `arvie_finder_taxonomy` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Déchargement des données de la table `arvie_finder_taxonomy`
--

INSERT INTO `arvie_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Structure de la table `arvie_finder_taxonomy_map`
--

CREATE TABLE `arvie_finder_taxonomy_map` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Structure de la table `arvie_finder_terms`
--

CREATE TABLE `arvie_finder_terms` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Structure de la table `arvie_finder_terms_common`
--

CREATE TABLE `arvie_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Déchargement des données de la table `arvie_finder_terms_common`
--

INSERT INTO `arvie_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Structure de la table `arvie_finder_tokens`
--

CREATE TABLE `arvie_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
  `phrase` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Structure de la table `arvie_finder_tokens_aggregate`
--

CREATE TABLE `arvie_finder_tokens_aggregate` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Structure de la table `arvie_finder_types`
--

CREATE TABLE `arvie_finder_types` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Structure de la table `arvie_languages`
--

CREATE TABLE `arvie_languages` (
...
--
-- Déchargement des données de la table `arvie_languages`
--

INSERT INTO `arvie_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
...
--
-- Structure de la table `arvie_menu`
--

CREATE TABLE `arvie_menu` (
  `id` int(11) NOT NULL,
...
--
-- Déchargement des données de la table `arvie_menu`
--
...
(108, 'main', 'com_annuaire', 'com-annuaire', '', 'com-annuaire', 'index.php?option=com_annuaire', 'component', 1, 1, 1, 10000, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 55, 60, 0, '', 1),
(109, 'main', 'com_annuaire_entreprises', 'com-annuaire-entreprises', '', 'com-annuaire/com-annuaire-entreprises', 'index.php?option=com_annuaire&view=entreprises', 'component', 1, 108, 2, 10000, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 56, 57, 0, '', 1),
(110, 'main', 'com_annuaire_contacts', 'com-annuaire-contacts', '', 'com-annuaire/com-annuaire-contacts', 'index.php?option=com_annuaire&view=contacts', 'component', 1, 108, 2, 10000, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 58, 59, 0, '', 1),
(111, 'menu-annuaire', 'Entreprises', 'entreprises', '', 'entreprises', 'index.php?option=com_annuaire&view=entreprises', 'component', 1, 1, 1, 10000, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{\"menu-anchor_title\":\"\",\"menu-anchor_css\":\"\",\"menu_image\":\"\",\"menu_image_css\":\"\",\"menu_text\":1,\"menu_show\":1,\"page_title\":\"\",\"show_page_heading\":\"\",\"page_heading\":\"\",\"pageclass_sfx\":\"\",\"menu-meta_description\":\"\",\"menu-meta_keywords\":\"\",\"robots\":\"\",\"secure\":0}', 61, 62, 0, '*', 0),
(112, 'menu-annuaire', 'Contacts', 'contacts', '', 'contacts', 'index.php?option=com_annuaire&view=contacts', 'component', 1, 1, 1, 10000, 0, '0000-00-00 00:00:00', 0, 1, ' ', 0, '{\"menu-anchor_title\":\"\",\"menu-anchor_css\":\"\",\"menu_image\":\"\",\"menu_image_css\":\"\",\"menu_text\":1,\"menu_show\":1,\"page_title\":\"\",\"show_page_heading\":\"\",\"page_heading\":\"\",\"pageclass_sfx\":\"\",\"menu-meta_description\":\"\",\"menu-meta_keywords\":\"\",\"robots\":\"\",\"secure\":0}', 63, 64, 0, '*', 0),
(147, 'main', 'com_arvie', 'com-arvie', '', 'com-arvie', 'index.php?option=com_arvie', 'component', 1, 1, 1, 10003, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 65, 82, 0, '', 1),
(148, 'main', 'com_arvie_abonnements', 'com-arvie-abonnements', '', 'com-arvie/com-arvie-abonnements', 'index.php?option=com_arvie&view=abonnements', 'component', 1, 147, 2, 10003, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 66, 67, 0, '', 1),
(149, 'main', 'com_arvie_discussions', 'com-arvie-discussions', '', 'com-arvie/com-arvie-discussions', 'index.php?option=com_arvie&view=discussions', 'component', 1, 147, 2, 10003, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 68, 69, 0, '', 1),
(150, 'main', 'com_arvie_evenements', 'com-arvie-evenements', '', 'com-arvie/com-arvie-evenements', 'index.php?option=com_arvie&view=evenements', 'component', 1, 147, 2, 10003, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 70, 71, 0, '', 1),
(151, 'main', 'com_arvie_groupes', 'com-arvie-groupes', '', 'com-arvie/com-arvie-groupes', 'index.php?option=com_arvie&view=groupes', 'component', 1, 147, 2, 10003, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 72, 73, 0, '', 1),
(152, 'main', 'com_arvie_messages', 'com-arvie-messages', '', 'com-arvie/com-arvie-messages', 'index.php?option=com_arvie&view=messages', 'component', 1, 147, 2, 10003, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 74, 75, 0, '', 1),
(153, 'main', 'com_arvie_parrains', 'com-arvie-parrains', '', 'com-arvie/com-arvie-parrains', 'index.php?option=com_arvie&view=parrains', 'component', 1, 147, 2, 10003, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 76, 77, 0, '', 1),
(154, 'main', 'com_arvie_publications', 'com-arvie-publications', '', 'com-arvie/com-arvie-publications', 'index.php?option=com_arvie&view=publications', 'component', 1, 147, 2, 10003, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 78, 79, 0, '', 1),
(155, 'main', 'com_arvie_utilisateurs', 'com-arvie-utilisateurs', '', 'com-arvie/com-arvie-utilisateurs', 'index.php?option=com_arvie&view=utilisateurs', 'component', 1, 147, 2, 10003, 0, '0000-00-00 00:00:00', 0, 1, 'class:component', 0, '{}', 80, 81, 0, '', 1);

-- --------------------------------------------------------

--
-- Structure de la table `arvie_menu_types`
--

CREATE TABLE `arvie_menu_types` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Déchargement des données de la table `arvie_menu_types`
--
...
--
-- Structure de la table `arvie_messages`
--

CREATE TABLE `arvie_messages` (
...
--
-- Structure de la table `arvie_messages_cfg`
--

CREATE TABLE `arvie_messages_cfg` (
...
--
-- Structure de la table `arvie_modules`
--

CREATE TABLE `arvie_modules` (
  `id` int(11) NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Déchargement des données de la table `arvie_modules`
--

INSERT INTO `arvie_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Structure de la table `arvie_modules_menu`
--

CREATE TABLE `arvie_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Déchargement des données de la table `arvie_modules_menu`
--

INSERT INTO `arvie_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Structure de la table `arvie_newsfeeds`
--

CREATE TABLE `arvie_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Structure de la table `arvie_overrider`
--

CREATE TABLE `arvie_overrider` (
...
--
-- Structure de la table `arvie_postinstall_messages`
--

CREATE TABLE `arvie_postinstall_messages` (
...
--
-- Déchargement des données de la table `arvie_postinstall_messages`
--

INSERT INTO `arvie_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Structure de la table `arvie_redirect_links`
--

CREATE TABLE `arvie_redirect_links` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Structure de la table `arvie_schemas`
--

CREATE TABLE `arvie_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Déchargement des données de la table `arvie_schemas`
--

INSERT INTO `arvie_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.8.2-2017-10-14');

-- --------------------------------------------------------

--
-- Structure de la table `arvie_session`
--

CREATE TABLE `arvie_session` (
...
--
-- Déchargement des données de la table `arvie_session`
--

INSERT INTO `arvie_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('a5essanfofeqh6p9s5aem2iv5a', 1, 0, '1512661272', 'joomla|s:744:\"\";', 416, 'SLAM'),
('nvr1oqvd1n7tbiutcsb05rskdf', 0, 1, '1512660925', 'joomla|s:736:\"\";', 0, '');

-- --------------------------------------------------------

--
-- Structure de la table `arvie_tags`
--

CREATE TABLE `arvie_tags` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Déchargement des données de la table `arvie_tags`
--

INSERT INTO `arvie_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 416, '2017-11-11 08:46:40', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Structure de la table `arvie_template_styles`
--

CREATE TABLE `arvie_template_styles` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Déchargement des données de la table `arvie_template_styles`
--

INSERT INTO `arvie_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
(4, 'beez3', 0, '0', 'Beez3 - Default', '{\"wrapperSmall\":\"53\",\"wrapperLarge\":\"72\",\"logo\":\"images\\/joomla_black.png\",\"sitetitle\":\"Joomla!\",\"sitedescription\":\"Open Source Content Management\",\"navposition\":\"left\",\"templatecolor\":\"personal\",\"html5\":\"0\"}'),
(5, 'hathor', 1, '0', 'Hathor - Default', '{\"showSiteName\":\"0\",\"colourChoice\":\"\",\"boldText\":\"0\"}'),
(7, 'protostar', 0, '0', 'protostar - Default', '{\"templateColor\":\"\",\"logoFile\":\"\",\"googleFont\":\"1\",\"googleFontName\":\"Open+Sans\",\"fluidContainer\":\"0\"}'),
(8, 'isis', 1, '1', 'isis - Default', '{\"templateColor\":\"\",\"logoFile\":\"\"}'),
(9, 'protostar', 0, '1', 'protostar - arvie', '{\"templateColor\":\"#066cb2\",\"templateBackgroundColor\":\"#f4f6f7\",\"logoFile\":\"images\\/arvie\\/logo-arvie.png\",\"sitetitle\":\"ArVie\",\"sitedescription\":\"Un site cr\\u00e9\\u00e9 par les \\u00e9tudiants du lyc\\u00e9e Louis-Armand - SITE DE TEST UNIQUEMENT !\",\"googleFont\":\"1\",\"googleFontName\":\"Open+Sans\",\"fluidContainer\":\"0\"}');

-- --------------------------------------------------------

--
-- Structure de la table `arvie_ucm_base`
--

CREATE TABLE `arvie_ucm_base` (
...
--
-- Structure de la table `arvie_ucm_content`
--

CREATE TABLE `arvie_ucm_content` (
...
--
-- Structure de la table `arvie_ucm_history`
--

CREATE TABLE `arvie_ucm_history` (
...
--
-- Déchargement des données de la table `arvie_ucm_history`
--

INSERT INTO `arvie_ucm_history` (`version_id`, `ucm_item_id`, `ucm_type_id`, `version_note`, `save_date`, `editor_user_id`, `character_count`, `sha1_hash`, `version_data`, `keep_forever`) VALUES
(1, 1, 2, '', '2017-11-11 09:09:36', 416, 1698, '9a1afee9284a32316839ea0b062fa8290d96e811', '{\"id\":1,\"name\":\"Info ArVie\",\"alias\":\"info-arvie\",\"con_position\":\"\",\"address\":\"\",\"suburb\":\"\",\"state\":\"\",\"country\":\"\",\"postcode\":\"\",\"telephone\":\"\",\"fax\":\"\",\"misc\":\"\",\"image\":\"\",\"email_to\":\"\",\"default_con\":0,\"published\":\"1\",\"checked_out\":null,\"checked_out_time\":null,\"ordering\":1,\"params\":\"{\\\"show_contact_category\\\":\\\"\\\",\\\"show_contact_list\\\":\\\"\\\",\\\"presentation_style\\\":\\\"\\\",\\\"show_tags\\\":\\\"\\\",\\\"show_info\\\":\\\"\\\",\\\"show_name\\\":\\\"\\\",\\\"show_position\\\":\\\"\\\",\\\"show_email\\\":\\\"\\\",\\\"add_mailto_link\\\":\\\"\\\",\\\"show_street_address\\\":\\\"\\\",\\\"show_suburb\\\":\\\"\\\",\\\"show_state\\\":\\\"\\\",\\\"show_postcode\\\":\\\"\\\",\\\"show_country\\\":\\\"\\\",\\\"show_telephone\\\":\\\"\\\",\\\"show_mobile\\\":\\\"\\\",\\\"show_fax\\\":\\\"\\\",\\\"show_webpage\\\":\\\"\\\",\\\"show_image\\\":\\\"\\\",\\\"show_misc\\\":\\\"\\\",\\\"allow_vcard\\\":\\\"\\\",\\\"show_articles\\\":\\\"\\\",\\\"articles_display_num\\\":\\\"\\\",\\\"show_profile\\\":\\\"\\\",\\\"show_links\\\":\\\"\\\",\\\"linka_name\\\":\\\"\\\",\\\"linka\\\":false,\\\"linkb_name\\\":\\\"\\\",\\\"linkb\\\":false,\\\"linkc_name\\\":\\\"\\\",\\\"linkc\\\":false,\\\"linkd_name\\\":\\\"\\\",\\\"linkd\\\":false,\\\"linke_name\\\":\\\"\\\",\\\"linke\\\":false,\\\"contact_layout\\\":\\\"\\\",\\\"show_email_form\\\":\\\"\\\",\\\"show_email_copy\\\":\\\"\\\",\\\"banned_email\\\":\\\"\\\",\\\"banned_subject\\\":\\\"\\\",\\\"banned_text\\\":\\\"\\\",\\\"validate_session\\\":\\\"\\\",\\\"custom_reply\\\":\\\"\\\",\\\"redirect\\\":\\\"\\\"}\",\"user_id\":\"417\",\"catid\":\"4\",\"access\":\"1\",\"mobile\":\"\",\"webpage\":false,\"sortname1\":\"\",\"sortname2\":\"\",\"sortname3\":\"\",\"language\":\"*\",\"created\":\"2017-11-11 09:09:36\",\"created_by\":\"416\",\"created_by_alias\":\"\",\"modified\":\"2017-11-11 09:09:36\",\"modified_by\":null,\"metakey\":\"\",\"metadesc\":\"\",\"metadata\":\"{\\\"robots\\\":\\\"\\\",\\\"rights\\\":\\\"\\\"}\",\"featured\":\"0\",\"xreference\":\"\",\"publish_up\":\"0000-00-00 00:00:00\",\"publish_down\":\"0000-00-00 00:00:00\",\"version\":1,\"hits\":null}', 0),
(2, 1, 1, '', '2017-11-11 09:11:26', 416, 2093, '94f37fd3f202a890ddd435c67677f4d50de49362', '{\"id\":1,\"asset_id\":56,\"title\":\"Bienvenue\",\"alias\":\"bienvenue\",\"introtext\":\"<p>Bienvenue sur le site \\u00e9cole r\\u00e9alis\\u00e9 par les \\u00e9tudiants en BTS-SIO option SLAM en 2e ann\\u00e9e qu Lyc\\u00e9e Louis Armand (Paris 15e).<\\/p>\\r\\n<p>Ce site ArVie.org est un r\\u00e9seau social destin\\u00e9 aux \\u00e9tudiants et personnels (direction, agents, professeurs) des lyc\\u00e9es Louis-Armand et Fran\\u00e7ois-Villon.<\\/p>\",\"fulltext\":\"\",\"state\":1,\"catid\":\"2\",\"created\":\"2017-11-11 09:11:26\",\"created_by\":\"416\",\"created_by_alias\":\"\",\"modified\":\"2017-11-11 09:11:26\",\"modified_by\":null,\"checked_out\":null,\"checked_out_time\":null,\"publish_up\":\"2017-11-11 09:11:26\",\"publish_down\":\"0000-00-00 00:00:00\",\"images\":\"{\\\"image_intro\\\":\\\"\\\",\\\"float_intro\\\":\\\"\\\",\\\"image_intro_alt\\\":\\\"\\\",\\\"image_intro_caption\\\":\\\"\\\",\\\"image_fulltext\\\":\\\"\\\",\\\"float_fulltext\\\":\\\"\\\",\\\"image_fulltext_alt\\\":\\\"\\\",\\\"image_fulltext_caption\\\":\\\"\\\"}\",\"urls\":\"{\\\"urla\\\":false,\\\"urlatext\\\":\\\"\\\",\\\"targeta\\\":\\\"\\\",\\\"urlb\\\":false,\\\"urlbtext\\\":\\\"\\\",\\\"targetb\\\":\\\"\\\",\\\"urlc\\\":false,\\\"urlctext\\\":\\\"\\\",\\\"targetc\\\":\\\"\\\"}\",\"attribs\":\"{\\\"article_layout\\\":\\\"\\\",\\\"show_title\\\":\\\"\\\",\\\"link_titles\\\":\\\"\\\",\\\"show_tags\\\":\\\"\\\",\\\"show_intro\\\":\\\"\\\",\\\"info_block_position\\\":\\\"\\\",\\\"info_block_show_title\\\":\\\"\\\",\\\"show_category\\\":\\\"\\\",\\\"link_category\\\":\\\"\\\",\\\"show_parent_category\\\":\\\"\\\",\\\"link_parent_category\\\":\\\"\\\",\\\"show_associations\\\":\\\"\\\",\\\"show_author\\\":\\\"\\\",\\\"link_author\\\":\\\"\\\",\\\"show_create_date\\\":\\\"\\\",\\\"show_modify_date\\\":\\\"\\\",\\\"show_publish_date\\\":\\\"\\\",\\\"show_item_navigation\\\":\\\"\\\",\\\"show_icons\\\":\\\"\\\",\\\"show_print_icon\\\":\\\"\\\",\\\"show_email_icon\\\":\\\"\\\",\\\"show_vote\\\":\\\"\\\",\\\"show_hits\\\":\\\"\\\",\\\"show_noauth\\\":\\\"\\\",\\\"urls_position\\\":\\\"\\\",\\\"alternative_readmore\\\":\\\"\\\",\\\"article_page_title\\\":\\\"\\\",\\\"show_publishing_options\\\":\\\"\\\",\\\"show_article_options\\\":\\\"\\\",\\\"show_urls_images_backend\\\":\\\"\\\",\\\"show_urls_images_frontend\\\":\\\"\\\"}\",\"version\":1,\"ordering\":null,\"metakey\":\"\",\"metadesc\":\"\",\"access\":\"1\",\"hits\":null,\"metadata\":\"{\\\"robots\\\":\\\"\\\",\\\"author\\\":\\\"\\\",\\\"rights\\\":\\\"\\\",\\\"xreference\\\":\\\"\\\"}\",\"featured\":\"0\",\"language\":\"*\",\"xreference\":\"\"}', 0),
(3, 2, 1, '', '2017-11-11 09:19:16', 416, 1849, 'a2e381e0c8bfd5894d80271fe4c8287f1d5007ad', '{\"id\":2,\"asset_id\":57,\"title\":\"Publications\",\"alias\":\"publications\",\"introtext\":\"<p>Cette page pr\\u00e9sente les publications et \\u00e9v\\u00e9nements des lyc\\u00e9es LA et FV.<\\/p>\",\"fulltext\":\"\",\"state\":1,\"catid\":\"2\",\"created\":\"2017-11-11 09:19:16\",\"created_by\":\"416\",\"created_by_alias\":\"\",\"modified\":\"2017-11-11 09:19:16\",\"modified_by\":null,\"checked_out\":null,\"checked_out_time\":null,\"publish_up\":\"2017-11-11 09:19:16\",\"publish_down\":\"0000-00-00 00:00:00\",\"images\":\"{\\\"image_intro\\\":\\\"\\\",\\\"float_intro\\\":\\\"\\\",\\\"image_intro_alt\\\":\\\"\\\",\\\"image_intro_caption\\\":\\\"\\\",\\\"image_fulltext\\\":\\\"\\\",\\\"float_fulltext\\\":\\\"\\\",\\\"image_fulltext_alt\\\":\\\"\\\",\\\"image_fulltext_caption\\\":\\\"\\\"}\",\"urls\":\"{\\\"urla\\\":false,\\\"urlatext\\\":\\\"\\\",\\\"targeta\\\":\\\"\\\",\\\"urlb\\\":false,\\\"urlbtext\\\":\\\"\\\",\\\"targetb\\\":\\\"\\\",\\\"urlc\\\":false,\\\"urlctext\\\":\\\"\\\",\\\"targetc\\\":\\\"\\\"}\",\"attribs\":\"{\\\"article_layout\\\":\\\"\\\",\\\"show_title\\\":\\\"\\\",\\\"link_titles\\\":\\\"\\\",\\\"show_tags\\\":\\\"\\\",\\\"show_intro\\\":\\\"\\\",\\\"info_block_position\\\":\\\"\\\",\\\"info_block_show_title\\\":\\\"\\\",\\\"show_category\\\":\\\"\\\",\\\"link_category\\\":\\\"\\\",\\\"show_parent_category\\\":\\\"\\\",\\\"link_parent_category\\\":\\\"\\\",\\\"show_associations\\\":\\\"\\\",\\\"show_author\\\":\\\"\\\",\\\"link_author\\\":\\\"\\\",\\\"show_create_date\\\":\\\"\\\",\\\"show_modify_date\\\":\\\"\\\",\\\"show_publish_date\\\":\\\"\\\",\\\"show_item_navigation\\\":\\\"\\\",\\\"show_icons\\\":\\\"\\\",\\\"show_print_icon\\\":\\\"\\\",\\\"show_email_icon\\\":\\\"\\\",\\\"show_vote\\\":\\\"\\\",\\\"show_hits\\\":\\\"\\\",\\\"show_noauth\\\":\\\"\\\",\\\"urls_position\\\":\\\"\\\",\\\"alternative_readmore\\\":\\\"\\\",\\\"article_page_title\\\":\\\"\\\",\\\"show_publishing_options\\\":\\\"\\\",\\\"show_article_options\\\":\\\"\\\",\\\"show_urls_images_backend\\\":\\\"\\\",\\\"show_urls_images_frontend\\\":\\\"\\\"}\",\"version\":1,\"ordering\":null,\"metakey\":\"\",\"metadesc\":\"\",\"access\":\"1\",\"hits\":null,\"metadata\":\"{\\\"robots\\\":\\\"\\\",\\\"author\\\":\\\"\\\",\\\"rights\\\":\\\"\\\",\\\"xreference\\\":\\\"\\\"}\",\"featured\":\"0\",\"language\":\"*\",\"xreference\":\"\"}', 0),
(4, 3, 1, '', '2017-11-11 09:26:26', 416, 1998, 'e35b2605d1149e6134fea98c16f314d0d8b54411', '{\"id\":3,\"asset_id\":58,\"title\":\"Discussions\",\"alias\":\"discussions\",\"introtext\":\"<p>Cette page est aux utilisateurs enregistr\\u00e9s et membres d\'un groupe (direction, agent, professeur, \\u00e9l\\u00e8ve ou ancien).<\\/p>\\r\\n<p>Elle pr\\u00e9sente les discussions en cours et permet d\'y participer ou d\'en cr\\u00e9er de nouvelles<\\/p>\",\"fulltext\":\"\",\"state\":1,\"catid\":\"2\",\"created\":\"2017-11-11 09:26:26\",\"created_by\":\"416\",\"created_by_alias\":\"\",\"modified\":\"2017-11-11 09:26:26\",\"modified_by\":null,\"checked_out\":null,\"checked_out_time\":null,\"publish_up\":\"2017-11-11 09:26:26\",\"publish_down\":\"0000-00-00 00:00:00\",\"images\":\"{\\\"image_intro\\\":\\\"\\\",\\\"float_intro\\\":\\\"\\\",\\\"image_intro_alt\\\":\\\"\\\",\\\"image_intro_caption\\\":\\\"\\\",\\\"image_fulltext\\\":\\\"\\\",\\\"float_fulltext\\\":\\\"\\\",\\\"image_fulltext_alt\\\":\\\"\\\",\\\"image_fulltext_caption\\\":\\\"\\\"}\",\"urls\":\"{\\\"urla\\\":false,\\\"urlatext\\\":\\\"\\\",\\\"targeta\\\":\\\"\\\",\\\"urlb\\\":false,\\\"urlbtext\\\":\\\"\\\",\\\"targetb\\\":\\\"\\\",\\\"urlc\\\":false,\\\"urlctext\\\":\\\"\\\",\\\"targetc\\\":\\\"\\\"}\",\"attribs\":\"{\\\"article_layout\\\":\\\"\\\",\\\"show_title\\\":\\\"\\\",\\\"link_titles\\\":\\\"\\\",\\\"show_tags\\\":\\\"\\\",\\\"show_intro\\\":\\\"\\\",\\\"info_block_position\\\":\\\"\\\",\\\"info_block_show_title\\\":\\\"\\\",\\\"show_category\\\":\\\"\\\",\\\"link_category\\\":\\\"\\\",\\\"show_parent_category\\\":\\\"\\\",\\\"link_parent_category\\\":\\\"\\\",\\\"show_associations\\\":\\\"\\\",\\\"show_author\\\":\\\"\\\",\\\"link_author\\\":\\\"\\\",\\\"show_create_date\\\":\\\"\\\",\\\"show_modify_date\\\":\\\"\\\",\\\"show_publish_date\\\":\\\"\\\",\\\"show_item_navigation\\\":\\\"\\\",\\\"show_icons\\\":\\\"\\\",\\\"show_print_icon\\\":\\\"\\\",\\\"show_email_icon\\\":\\\"\\\",\\\"show_vote\\\":\\\"\\\",\\\"show_hits\\\":\\\"\\\",\\\"show_noauth\\\":\\\"\\\",\\\"urls_position\\\":\\\"\\\",\\\"alternative_readmore\\\":\\\"\\\",\\\"article_page_title\\\":\\\"\\\",\\\"show_publishing_options\\\":\\\"\\\",\\\"show_article_options\\\":\\\"\\\",\\\"show_urls_images_backend\\\":\\\"\\\",\\\"show_urls_images_frontend\\\":\\\"\\\"}\",\"version\":1,\"ordering\":null,\"metakey\":\"\",\"metadesc\":\"\",\"access\":\"2\",\"hits\":null,\"metadata\":\"{\\\"robots\\\":\\\"\\\",\\\"author\\\":\\\"\\\",\\\"rights\\\":\\\"\\\",\\\"xreference\\\":\\\"\\\"}\",\"featured\":\"0\",\"language\":\"*\",\"xreference\":\"\"}', 0),
(5, 2, 1, '', '2017-11-11 09:27:41', 416, 2087, '801cf880108d41da4e5a9c9dd772a0be3f9e8ba1', '{\"id\":2,\"asset_id\":\"57\",\"title\":\"Publications\",\"alias\":\"publications\",\"introtext\":\"<p>Cette page pr\\u00e9sente les publications et \\u00e9v\\u00e9nements des lyc\\u00e9es LA et FV.<\\/p>\\r\\n<p>La cr\\u00e9ation de publications ou d\'\\u00e9v\\u00e9nements\\u00a0est r\\u00e9serv\\u00e9e aux\\u00a0utilisateurs enregistr\\u00e9s et membres d\'un groupe (direction, agent, professeur, \\u00e9l\\u00e8ve ou ancien).<\\/p>\",\"fulltext\":\"\",\"state\":1,\"catid\":\"2\",\"created\":\"2017-11-11 09:19:16\",\"created_by\":\"416\",\"created_by_alias\":\"\",\"modified\":\"2017-11-11 09:27:41\",\"modified_by\":\"416\",\"checked_out\":\"416\",\"checked_out_time\":\"2017-11-11 09:26:34\",\"publish_up\":\"2017-11-11 09:19:16\",\"publish_down\":\"0000-00-00 00:00:00\",\"images\":\"{\\\"image_intro\\\":\\\"\\\",\\\"float_intro\\\":\\\"\\\",\\\"image_intro_alt\\\":\\\"\\\",\\\"image_intro_caption\\\":\\\"\\\",\\\"image_fulltext\\\":\\\"\\\",\\\"float_fulltext\\\":\\\"\\\",\\\"image_fulltext_alt\\\":\\\"\\\",\\\"image_fulltext_caption\\\":\\\"\\\"}\",\"urls\":\"{\\\"urla\\\":false,\\\"urlatext\\\":\\\"\\\",\\\"targeta\\\":\\\"\\\",\\\"urlb\\\":false,\\\"urlbtext\\\":\\\"\\\",\\\"targetb\\\":\\\"\\\",\\\"urlc\\\":false,\\\"urlctext\\\":\\\"\\\",\\\"targetc\\\":\\\"\\\"}\",\"attribs\":\"{\\\"article_layout\\\":\\\"\\\",\\\"show_title\\\":\\\"\\\",\\\"link_titles\\\":\\\"\\\",\\\"show_tags\\\":\\\"\\\",\\\"show_intro\\\":\\\"\\\",\\\"info_block_position\\\":\\\"\\\",\\\"info_block_show_title\\\":\\\"\\\",\\\"show_category\\\":\\\"\\\",\\\"link_category\\\":\\\"\\\",\\\"show_parent_category\\\":\\\"\\\",\\\"link_parent_category\\\":\\\"\\\",\\\"show_associations\\\":\\\"\\\",\\\"show_author\\\":\\\"\\\",\\\"link_author\\\":\\\"\\\",\\\"show_create_date\\\":\\\"\\\",\\\"show_modify_date\\\":\\\"\\\",\\\"show_publish_date\\\":\\\"\\\",\\\"show_item_navigation\\\":\\\"\\\",\\\"show_icons\\\":\\\"\\\",\\\"show_print_icon\\\":\\\"\\\",\\\"show_email_icon\\\":\\\"\\\",\\\"show_vote\\\":\\\"\\\",\\\"show_hits\\\":\\\"\\\",\\\"show_noauth\\\":\\\"\\\",\\\"urls_position\\\":\\\"\\\",\\\"alternative_readmore\\\":\\\"\\\",\\\"article_page_title\\\":\\\"\\\",\\\"show_publishing_options\\\":\\\"\\\",\\\"show_article_options\\\":\\\"\\\",\\\"show_urls_images_backend\\\":\\\"\\\",\\\"show_urls_images_frontend\\\":\\\"\\\"}\",\"version\":2,\"ordering\":\"1\",\"metakey\":\"\",\"metadesc\":\"\",\"access\":\"1\",\"hits\":\"0\",\"metadata\":\"{\\\"robots\\\":\\\"\\\",\\\"author\\\":\\\"\\\",\\\"rights\\\":\\\"\\\",\\\"xreference\\\":\\\"\\\"}\",\"featured\":\"0\",\"language\":\"*\",\"xreference\":\"\"}', 0),
(6, 4, 1, '', '2017-11-11 09:29:38', 416, 1854, '884ef738515f4b2844520e219837da76a3724a1c', '{\"id\":4,\"asset_id\":59,\"title\":\"BTS-SIO\",\"alias\":\"bts-sio\",\"introtext\":\"<p>Le BTS-SIO, r\\u00e9nov\\u00e9 en 2011, forme en deux ans des techniciens sup\\u00e9rieurs en informatique...<\\/p>\",\"fulltext\":\"\",\"state\":1,\"catid\":\"2\",\"created\":\"2017-11-11 09:29:38\",\"created_by\":\"416\",\"created_by_alias\":\"\",\"modified\":\"2017-11-11 09:29:38\",\"modified_by\":null,\"checked_out\":null,\"checked_out_time\":null,\"publish_up\":\"2017-11-11 09:29:38\",\"publish_down\":\"0000-00-00 00:00:00\",\"images\":\"{\\\"image_intro\\\":\\\"\\\",\\\"float_intro\\\":\\\"\\\",\\\"image_intro_alt\\\":\\\"\\\",\\\"image_intro_caption\\\":\\\"\\\",\\\"image_fulltext\\\":\\\"\\\",\\\"float_fulltext\\\":\\\"\\\",\\\"image_fulltext_alt\\\":\\\"\\\",\\\"image_fulltext_caption\\\":\\\"\\\"}\",\"urls\":\"{\\\"urla\\\":false,\\\"urlatext\\\":\\\"\\\",\\\"targeta\\\":\\\"\\\",\\\"urlb\\\":false,\\\"urlbtext\\\":\\\"\\\",\\\"targetb\\\":\\\"\\\",\\\"urlc\\\":false,\\\"urlctext\\\":\\\"\\\",\\\"targetc\\\":\\\"\\\"}\",\"attribs\":\"{\\\"article_layout\\\":\\\"\\\",\\\"show_title\\\":\\\"\\\",\\\"link_titles\\\":\\\"\\\",\\\"show_tags\\\":\\\"\\\",\\\"show_intro\\\":\\\"\\\",\\\"info_block_position\\\":\\\"\\\",\\\"info_block_show_title\\\":\\\"\\\",\\\"show_category\\\":\\\"\\\",\\\"link_category\\\":\\\"\\\",\\\"show_parent_category\\\":\\\"\\\",\\\"link_parent_category\\\":\\\"\\\",\\\"show_associations\\\":\\\"\\\",\\\"show_author\\\":\\\"\\\",\\\"link_author\\\":\\\"\\\",\\\"show_create_date\\\":\\\"\\\",\\\"show_modify_date\\\":\\\"\\\",\\\"show_publish_date\\\":\\\"\\\",\\\"show_item_navigation\\\":\\\"\\\",\\\"show_icons\\\":\\\"\\\",\\\"show_print_icon\\\":\\\"\\\",\\\"show_email_icon\\\":\\\"\\\",\\\"show_vote\\\":\\\"\\\",\\\"show_hits\\\":\\\"\\\",\\\"show_noauth\\\":\\\"\\\",\\\"urls_position\\\":\\\"\\\",\\\"alternative_readmore\\\":\\\"\\\",\\\"article_page_title\\\":\\\"\\\",\\\"show_publishing_options\\\":\\\"\\\",\\\"show_article_options\\\":\\\"\\\",\\\"show_urls_images_backend\\\":\\\"\\\",\\\"show_urls_images_frontend\\\":\\\"\\\"}\",\"version\":1,\"ordering\":null,\"metakey\":\"\",\"metadesc\":\"\",\"access\":\"1\",\"hits\":null,\"metadata\":\"{\\\"robots\\\":\\\"\\\",\\\"author\\\":\\\"\\\",\\\"rights\\\":\\\"\\\",\\\"xreference\\\":\\\"\\\"}\",\"featured\":\"0\",\"language\":\"*\",\"xreference\":\"\"}', 0),
(7, 5, 1, '', '2017-11-11 09:32:07', 416, 2543, '06128df8397aa12e8325290bccb9e238280dae90', '{\"id\":5,\"asset_id\":60,\"title\":\"Louis-Armand\",\"alias\":\"louis-armand\",\"introtext\":\"<p><span>Dans le sud de PARIS, au 321 rue Lecourbe 75015 PARIS, le lyc\\u00e9e polyvalent Louis Armand offre aux \\u00e9l\\u00e8ves de seconde g\\u00e9n\\u00e9rale un parcours diversifi\\u00e9 :<\\/span><\\/p>\\r\\n<p><span>Voie g\\u00e9n\\u00e9rale : BAC ES, BAC S-SI, BAC S-SVT.<\\/span><\\/p>\\r\\n<p><span>Voie technologique : BAC STI2D et BAC STMG.<\\/span><\\/p>\\r\\n<p><span>Voie professionnelle : BAC PRO Syst\\u00e8mes Electroniques et Num\\u00e9riques \\/ BAC PRO ELEEC (Electrotechnique-Energie-Equipements Communicants).<\\/span><\\/p>\\r\\n<p><span>Apr\\u00e8s le BAC, vous pouvez poursuivre vos \\u00e9tudes sup\\u00e9rieures chez nous :<\\/span><\\/p>\\r\\n<p><span>BTS MUC - BTS PME\\/PMI - BTS syst\\u00e8mes num\\u00e9riques - BTS \\u00e9lectrotechnique - BTS Service Informatique aux Organisations.<\\/span><\\/p>\",\"fulltext\":\"\",\"state\":1,\"catid\":\"2\",\"created\":\"2017-11-11 09:32:07\",\"created_by\":\"416\",\"created_by_alias\":\"\",\"modified\":\"2017-11-11 09:32:07\",\"modified_by\":null,\"checked_out\":null,\"checked_out_time\":null,\"publish_up\":\"2017-11-11 09:32:07\",\"publish_down\":\"0000-00-00 00:00:00\",\"images\":\"{\\\"image_intro\\\":\\\"\\\",\\\"float_intro\\\":\\\"\\\",\\\"image_intro_alt\\\":\\\"\\\",\\\"image_intro_caption\\\":\\\"\\\",\\\"image_fulltext\\\":\\\"\\\",\\\"float_fulltext\\\":\\\"\\\",\\\"image_fulltext_alt\\\":\\\"\\\",\\\"image_fulltext_caption\\\":\\\"\\\"}\",\"urls\":\"{\\\"urla\\\":false,\\\"urlatext\\\":\\\"\\\",\\\"targeta\\\":\\\"\\\",\\\"urlb\\\":false,\\\"urlbtext\\\":\\\"\\\",\\\"targetb\\\":\\\"\\\",\\\"urlc\\\":false,\\\"urlctext\\\":\\\"\\\",\\\"targetc\\\":\\\"\\\"}\",\"attribs\":\"{\\\"article_layout\\\":\\\"\\\",\\\"show_title\\\":\\\"\\\",\\\"link_titles\\\":\\\"\\\",\\\"show_tags\\\":\\\"\\\",\\\"show_intro\\\":\\\"\\\",\\\"info_block_position\\\":\\\"\\\",\\\"info_block_show_title\\\":\\\"\\\",\\\"show_category\\\":\\\"\\\",\\\"link_category\\\":\\\"\\\",\\\"show_parent_category\\\":\\\"\\\",\\\"link_parent_category\\\":\\\"\\\",\\\"show_associations\\\":\\\"\\\",\\\"show_author\\\":\\\"\\\",\\\"link_author\\\":\\\"\\\",\\\"show_create_date\\\":\\\"\\\",\\\"show_modify_date\\\":\\\"\\\",\\\"show_publish_date\\\":\\\"\\\",\\\"show_item_navigation\\\":\\\"\\\",\\\"show_icons\\\":\\\"\\\",\\\"show_print_icon\\\":\\\"\\\",\\\"show_email_icon\\\":\\\"\\\",\\\"show_vote\\\":\\\"\\\",\\\"show_hits\\\":\\\"\\\",\\\"show_noauth\\\":\\\"\\\",\\\"urls_position\\\":\\\"\\\",\\\"alternative_readmore\\\":\\\"\\\",\\\"article_page_title\\\":\\\"\\\",\\\"show_publishing_options\\\":\\\"\\\",\\\"show_article_options\\\":\\\"\\\",\\\"show_urls_images_backend\\\":\\\"\\\",\\\"show_urls_images_frontend\\\":\\\"\\\"}\",\"version\":1,\"ordering\":null,\"metakey\":\"\",\"metadesc\":\"\",\"access\":\"1\",\"hits\":null,\"metadata\":\"{\\\"robots\\\":\\\"\\\",\\\"author\\\":\\\"\\\",\\\"rights\\\":\\\"\\\",\\\"xreference\\\":\\\"\\\"}\",\"featured\":\"0\",\"language\":\"*\",\"xreference\":\"\"}', 0),
(8, 1, 1, '', '2017-11-11 10:30:07', 416, 2201, 'f03d0ba9304965fb65e7cac8d720c73ae3643f00', '{\"id\":1,\"asset_id\":\"56\",\"title\":\"Bienvenue\",\"alias\":\"bienvenue\",\"introtext\":\"<p>Bienvenue sur le site \\u00e9cole r\\u00e9alis\\u00e9 par les \\u00e9tudiants en BTS-SIO option SLAM en 2e ann\\u00e9e qu Lyc\\u00e9e Louis Armand (Paris 15e).<\\/p>\\r\\n<p>ArVie est un r\\u00e9seau social destin\\u00e9 aux \\u00e9l\\u00e8ves, \\u00e9tudiants, professeurs, personnels et anciens des lyc\\u00e9es Louis-Armand et Fran\\u00e7ois-Villon.<\\/p>\\r\\n<p>Il est accessible depuis ce site ArVie.org et depuis l\'application Android ArVie.<\\/p>\",\"fulltext\":\"\",\"state\":1,\"catid\":\"2\",\"created\":\"2017-11-11 09:11:26\",\"created_by\":\"416\",\"created_by_alias\":\"\",\"modified\":\"2017-11-11 10:30:07\",\"modified_by\":\"416\",\"checked_out\":\"416\",\"checked_out_time\":\"2017-11-11 10:26:03\",\"publish_up\":\"2017-11-11 09:11:26\",\"publish_down\":\"0000-00-00 00:00:00\",\"images\":\"{\\\"image_intro\\\":\\\"\\\",\\\"float_intro\\\":\\\"\\\",\\\"image_intro_alt\\\":\\\"\\\",\\\"image_intro_caption\\\":\\\"\\\",\\\"image_fulltext\\\":\\\"\\\",\\\"float_fulltext\\\":\\\"\\\",\\\"image_fulltext_alt\\\":\\\"\\\",\\\"image_fulltext_caption\\\":\\\"\\\"}\",\"urls\":\"{\\\"urla\\\":false,\\\"urlatext\\\":\\\"\\\",\\\"targeta\\\":\\\"\\\",\\\"urlb\\\":false,\\\"urlbtext\\\":\\\"\\\",\\\"targetb\\\":\\\"\\\",\\\"urlc\\\":false,\\\"urlctext\\\":\\\"\\\",\\\"targetc\\\":\\\"\\\"}\",\"attribs\":\"{\\\"article_layout\\\":\\\"\\\",\\\"show_title\\\":\\\"\\\",\\\"link_titles\\\":\\\"\\\",\\\"show_tags\\\":\\\"\\\",\\\"show_intro\\\":\\\"\\\",\\\"info_block_position\\\":\\\"\\\",\\\"info_block_show_title\\\":\\\"\\\",\\\"show_category\\\":\\\"\\\",\\\"link_category\\\":\\\"\\\",\\\"show_parent_category\\\":\\\"\\\",\\\"link_parent_category\\\":\\\"\\\",\\\"show_associations\\\":\\\"\\\",\\\"show_author\\\":\\\"\\\",\\\"link_author\\\":\\\"\\\",\\\"show_create_date\\\":\\\"\\\",\\\"show_modify_date\\\":\\\"\\\",\\\"show_publish_date\\\":\\\"\\\",\\\"show_item_navigation\\\":\\\"\\\",\\\"show_icons\\\":\\\"\\\",\\\"show_print_icon\\\":\\\"\\\",\\\"show_email_icon\\\":\\\"\\\",\\\"show_vote\\\":\\\"\\\",\\\"show_hits\\\":\\\"\\\",\\\"show_noauth\\\":\\\"\\\",\\\"urls_position\\\":\\\"\\\",\\\"alternative_readmore\\\":\\\"\\\",\\\"article_page_title\\\":\\\"\\\",\\\"show_publishing_options\\\":\\\"\\\",\\\"show_article_options\\\":\\\"\\\",\\\"show_urls_images_backend\\\":\\\"\\\",\\\"show_urls_images_frontend\\\":\\\"\\\"}\",\"version\":2,\"ordering\":\"4\",\"metakey\":\"\",\"metadesc\":\"\",\"access\":\"1\",\"hits\":\"11\",\"metadata\":\"{\\\"robots\\\":\\\"\\\",\\\"author\\\":\\\"\\\",\\\"rights\\\":\\\"\\\",\\\"xreference\\\":\\\"\\\"}\",\"featured\":\"0\",\"language\":\"*\",\"xreference\":\"\"}', 0);

-- --------------------------------------------------------

--
-- Structure de la table `arvie_updates`
--

CREATE TABLE `arvie_updates` (
...
--
-- Déchargement des données de la table `arvie_updates`
--

INSERT INTO `arvie_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
(1, 2, 0, 'Macedonian', '', 'pkg_mk-MK', 'package', '', 0, '3.6.5.1', '', 'https://update.joomla.org/language/details3/mk-MK_details.xml', '', ''),
(2, 2, 0, 'Norwegian Bokmal', '', 'pkg_nb-NO', 'package', '', 0, '3.7.4.1', '', 'https://update.joomla.org/language/details3/nb-NO_details.xml', '', ''),
(3, 2, 0, 'Norwegian Nynorsk', '', 'pkg_nn-NO', 'package', '', 0, '3.4.2.1', '', 'https://update.joomla.org/language/details3/nn-NO_details.xml', '', ''),
(4, 2, 0, 'Persian', '', 'pkg_fa-IR', 'package', '', 0, '3.8.2.1', '', 'https://update.joomla.org/language/details3/fa-IR_details.xml', '', ''),
(5, 2, 0, 'Polish', '', 'pkg_pl-PL', 'package', '', 0, '3.8.2.2', '', 'https://update.joomla.org/language/details3/pl-PL_details.xml', '', ''),
(6, 2, 0, 'Portuguese', '', 'pkg_pt-PT', 'package', '', 0, '3.8.2.1', '', 'https://update.joomla.org/language/details3/pt-PT_details.xml', '', ''),
(7, 2, 0, 'Russian', '', 'pkg_ru-RU', 'package', '', 0, '3.8.2.1', '', 'https://update.joomla.org/language/details3/ru-RU_details.xml', '', ''),
(8, 2, 0, 'English AU', '', 'pkg_en-AU', 'package', '', 0, '3.6.5.1', '', 'https://update.joomla.org/language/details3/en-AU_details.xml', '', ''),
(9, 2, 0, 'Slovak', '', 'pkg_sk-SK', 'package', '', 0, '3.8.1.1', '', 'https://update.joomla.org/language/details3/sk-SK_details.xml', '', ''),
(10, 2, 0, 'English US', '', 'pkg_en-US', 'package', '', 0, '3.6.5.1', '', 'https://update.joomla.org/language/details3/en-US_details.xml', '', ''),
(11, 2, 0, 'Swedish', '', 'pkg_sv-SE', 'package', '', 0, '3.8.2.1', '', 'https://update.joomla.org/language/details3/sv-SE_details.xml', '', ''),
(12, 2, 0, 'Syriac', '', 'pkg_sy-IQ', 'package', '', 0, '3.4.5.1', '', 'https://update.joomla.org/language/details3/sy-IQ_details.xml', '', ''),
(13, 2, 0, 'Tamil', '', 'pkg_ta-IN', 'package', '', 0, '3.8.2.1', '', 'https://update.joomla.org/language/details3/ta-IN_details.xml', '', ''),
(14, 2, 0, 'Thai', '', 'pkg_th-TH', 'package', '', 0, '3.8.2.1', '', 'https://update.joomla.org/language/details3/th-TH_details.xml', '', ''),
(15, 2, 0, 'Turkish', '', 'pkg_tr-TR', 'package', '', 0, '3.8.2.1', '', 'https://update.joomla.org/language/details3/tr-TR_details.xml', '', ''),
(16, 2, 0, 'Ukrainian', '', 'pkg_uk-UA', 'package', '', 0, '3.7.1.1', '', 'https://update.joomla.org/language/details3/uk-UA_details.xml', '', ''),
(17, 2, 0, 'Uyghur', '', 'pkg_ug-CN', 'package', '', 0, '3.7.5.1', '', 'https://update.joomla.org/language/details3/ug-CN_details.xml', '', ''),
(18, 2, 0, 'Albanian', '', 'pkg_sq-AL', 'package', '', 0, '3.1.1.2', '', 'https://update.joomla.org/language/details3/sq-AL_details.xml', '', ''),
(19, 2, 0, 'Basque', '', 'pkg_eu-ES', 'package', '', 0, '3.7.5.1', '', 'https://update.joomla.org/language/details3/eu-ES_details.xml', '', ''),
(20, 2, 0, 'Hindi', '', 'pkg_hi-IN', 'package', '', 0, '3.3.6.2', '', 'https://update.joomla.org/language/details3/hi-IN_details.xml', '', ''),
(21, 2, 0, 'German DE', '', 'pkg_de-DE', 'package', '', 0, '3.8.2.1', '', 'https://update.joomla.org/language/details3/de-DE_details.xml', '', ''),
(22, 2, 0, 'Portuguese Brazil', '', 'pkg_pt-BR', 'package', '', 0, '3.8.2.1', '', 'https://update.joomla.org/language/details3/pt-BR_details.xml', '', ''),
(23, 2, 0, 'Serbian Latin', '', 'pkg_sr-YU', 'package', '', 0, '3.8.2.1', '', 'https://update.joomla.org/language/details3/sr-YU_details.xml', '', ''),
(24, 2, 0, 'Spanish', '', 'pkg_es-ES', 'package', '', 0, '3.7.2.1', '', 'https://update.joomla.org/language/details3/es-ES_details.xml', '', ''),
(25, 2, 0, 'Bosnian', '', 'pkg_bs-BA', 'package', '', 0, '3.7.5.1', '', 'https://update.joomla.org/language/details3/bs-BA_details.xml', '', ''),
(26, 2, 0, 'Serbian Cyrillic', '', 'pkg_sr-RS', 'package', '', 0, '3.8.2.1', '', 'https://update.joomla.org/language/details3/sr-RS_details.xml', '', ''),
(27, 2, 0, 'Vietnamese', '', 'pkg_vi-VN', 'package', '', 0, '3.2.1.2', '', 'https://update.joomla.org/language/details3/vi-VN_details.xml', '', ''),
(28, 2, 0, 'Bahasa Indonesia', '', 'pkg_id-ID', 'package', '', 0, '3.6.2.1', '', 'https://update.joomla.org/language/details3/id-ID_details.xml', '', ''),
(29, 2, 0, 'Finnish', '', 'pkg_fi-FI', 'package', '', 0, '3.8.1.1', '', 'https://update.joomla.org/language/details3/fi-FI_details.xml', '', ''),
(30, 2, 0, 'Swahili', '', 'pkg_sw-KE', 'package', '', 0, '3.6.5.1', '', 'https://update.joomla.org/language/details3/sw-KE_details.xml', '', ''),
(31, 2, 0, 'Montenegrin', '', 'pkg_srp-ME', 'package', '', 0, '3.3.1.2', '', 'https://update.joomla.org/language/details3/srp-ME_details.xml', '', ''),
(32, 2, 0, 'English CA', '', 'pkg_en-CA', 'package', '', 0, '3.6.5.1', '', 'https://update.joomla.org/language/details3/en-CA_details.xml', '', ''),
(33, 2, 0, 'French CA', '', 'pkg_fr-CA', 'package', '', 0, '3.6.5.1', '', 'https://update.joomla.org/language/details3/fr-CA_details.xml', '', ''),
(34, 2, 0, 'Welsh', '', 'pkg_cy-GB', 'package', '', 0, '3.8.2.1', '', 'https://update.joomla.org/language/details3/cy-GB_details.xml', '', ''),
(35, 2, 0, 'Sinhala', '', 'pkg_si-LK', 'package', '', 0, '3.3.1.2', '', 'https://update.joomla.org/language/details3/si-LK_details.xml', '', ''),
(36, 2, 0, 'Dari Persian', '', 'pkg_prs-AF', 'package', '', 0, '3.4.4.2', '', 'https://update.joomla.org/language/details3/prs-AF_details.xml', '', ''),
(37, 2, 0, 'Turkmen', '', 'pkg_tk-TM', 'package', '', 0, '3.5.0.2', '', 'https://update.joomla.org/language/details3/tk-TM_details.xml', '', ''),
(38, 2, 0, 'Irish', '', 'pkg_ga-IE', 'package', '', 0, '3.8.2.1', '', 'https://update.joomla.org/language/details3/ga-IE_details.xml', '', ''),
(39, 2, 0, 'Dzongkha', '', 'pkg_dz-BT', 'package', '', 0, '3.6.2.1', '', 'https://update.joomla.org/language/details3/dz-BT_details.xml', '', ''),
(40, 2, 0, 'Slovenian', '', 'pkg_sl-SI', 'package', '', 0, '3.8.2.1', '', 'https://update.joomla.org/language/details3/sl-SI_details.xml', '', ''),
(41, 2, 0, 'Spanish CO', '', 'pkg_es-CO', 'package', '', 0, '3.8.2.1', '', 'https://update.joomla.org/language/details3/es-CO_details.xml', '', ''),
(42, 2, 0, 'German CH', '', 'pkg_de-CH', 'package', '', 0, '3.8.2.1', '', 'https://update.joomla.org/language/details3/de-CH_details.xml', '', ''),
(43, 2, 0, 'German AT', '', 'pkg_de-AT', 'package', '', 0, '3.8.2.1', '', 'https://update.joomla.org/language/details3/de-AT_details.xml', '', ''),
(44, 2, 0, 'German LI', '', 'pkg_de-LI', 'package', '', 0, '3.8.2.1', '', 'https://update.joomla.org/language/details3/de-LI_details.xml', '', ''),
(45, 2, 0, 'German LU', '', 'pkg_de-LU', 'package', '', 0, '3.8.2.1', '', 'https://update.joomla.org/language/details3/de-LU_details.xml', '', ''),
(46, 2, 0, 'English NZ', '', 'pkg_en-NZ', 'package', '', 0, '3.6.5.1', '', 'https://update.joomla.org/language/details3/en-NZ_details.xml', '', '');

-- --------------------------------------------------------

--
-- Structure de la table `arvie_update_sites`
--

CREATE TABLE `arvie_update_sites` (
...
--
-- Déchargement des données de la table `arvie_update_sites`
--

INSERT INTO `arvie_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1512651818, ''),
(2, 'Accredited Joomla! Translations', 'collection', 'https://update.joomla.org/language/translationlist_3.xml', 1, 1512651820, ''),
(3, 'Joomla! Update Component Update Site', 'extension', 'https://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1512651820, '');

-- --------------------------------------------------------

--
-- Structure de la table `arvie_update_sites_extensions`
--

CREATE TABLE `arvie_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Links extensions to update sites';

--
-- Déchargement des données de la table `arvie_update_sites_extensions`
--

INSERT INTO `arvie_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 802),
(3, 28),
(5, 605);
...
--
-- Structure de la table `arvie_usergroups`
--

CREATE TABLE `arvie_usergroups` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
...
--
-- Déchargement des données de la table `arvie_usergroups`
--

INSERT INTO `arvie_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 34, 'Public'),
(2, 1, 2, 25, 'Enregistré'),
(3, 2, 19, 24, 'Auteur'),
(4, 3, 20, 23, 'Rédacteur'),
(5, 4, 21, 22, 'Validateur'),
(6, 1, 26, 29, 'Gestionnaire'),
(7, 6, 27, 28, 'Administrateur'),
(8, 1, 32, 33, 'Super Utilisateur'),
(9, 1, 30, 31, 'Invité'),
(10, 2, 5, 18, 'ArVie'),
(11, 10, 6, 7, 'ArVie Administrateur'),
(12, 10, 12, 13, 'ArVie Direction'),
(13, 10, 8, 9, 'ArVie Agent'),
(14, 10, 16, 17, 'ArVie Professeur'),
(15, 10, 14, 15, 'ArVie Eleve'),
(16, 10, 10, 11, 'ArVie Ancien'),
(17, 2, 3, 4, 'Annuaire');

-- --------------------------------------------------------

--
-- Structure de la table `arvie_users`
--

CREATE TABLE `arvie_users` (
  `id` int(11) NOT NULL,
...
--
-- Déchargement des données de la table `arvie_users`
--
...
(416, 'Super Utilisateur', 'SLAM', 'emmanuel.derome@gmail.com', '$2y$10$.3gLjjdoOIexzDzlyZFEFuZUKHtzOTMimdK.Adj85unSnx0gN/5f2', 0, 1, '2017-11-11 08:46:40', '2017-12-07 15:40:50', '0', '', '0000-00-00 00:00:00', 0, '', '', 0),
...
--
-- Structure de la table `arvie_user_keys`
--

CREATE TABLE `arvie_user_keys` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Structure de la table `arvie_user_notes`
--

CREATE TABLE `arvie_user_notes` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `catid` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Structure de la table `arvie_user_profiles`
--

CREATE TABLE `arvie_user_profiles` (
...
--
-- Structure de la table `arvie_user_usergroup_map`
--

CREATE TABLE `arvie_user_usergroup_map` (
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Déchargement des données de la table `arvie_user_usergroup_map`
--
...
--
-- Structure de la table `arvie_utf8_conversion`
--

CREATE TABLE `arvie_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Déchargement des données de la table `arvie_utf8_conversion`
--

INSERT INTO `arvie_utf8_conversion` (`converted`) VALUES
(2);

-- --------------------------------------------------------

--
-- Structure de la table `arvie_viewlevels`
--

CREATE TABLE `arvie_viewlevels` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Déchargement des données de la table `arvie_viewlevels`
--

INSERT INTO `arvie_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Accès public', 0, '[1]'),
(2, 'Accès enregistré', 2, '[6,2,8]'),
(3, 'Accès spécial', 3, '[6,3,8]'),
(5, 'Accès invité', 1, '[9]'),
(6, 'Accès super utilisateur', 4, '[8]'),
(7, 'ArVie', 0, '[11,13,16,12,15,14]'),
(8, 'ArVie Administrateur', 0, '[11]'),
(9, 'Annuaire', 0, '[17]');
...
--
-- Index pour la table `arvie_annuaire_civilites`
--
ALTER TABLE `arvie_annuaire_civilites`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `arvie_annuaire_contacts`
--
ALTER TABLE `arvie_annuaire_contacts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_arvie_annuaire_civilites_id` (`civilites_id`),
  ADD KEY `fk_arvie_annuaire_typescontacts_id` (`typescontacts_id`),
  ADD KEY `fk_arvie_annuaire_entreprises_id` (`entreprises_id`);

--
-- Index pour la table `arvie_annuaire_entreprises`
--
ALTER TABLE `arvie_annuaire_entreprises`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_arvie_annuaire_pays_id` (`pays_id`);

--
-- Index pour la table `arvie_annuaire_pays`
--
ALTER TABLE `arvie_annuaire_pays`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `arvie_annuaire_typescontacts`
--
...
--
-- Index pour la table `arvie_associations`
--
ALTER TABLE `arvie_associations`
  ADD PRIMARY KEY (`context`,`id`),
  ADD KEY `idx_key` (`key`);

--
-- Index pour la table `arvie_banners`
--
ALTER TABLE `arvie_banners`
  ADD PRIMARY KEY (`id`),
...
--
-- Index pour la table `arvie_banner_clients`
--
ALTER TABLE `arvie_banner_clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_own_prefix` (`own_prefix`),
  ADD KEY `idx_metakey_prefix` (`metakey_prefix`(100));

--
-- Index pour la table `arvie_banner_tracks`
--
ALTER TABLE `arvie_banner_tracks`
...
--
-- Index pour la table `arvie_categories`
--
ALTER TABLE `arvie_categories`
  ADD PRIMARY KEY (`id`),
...
--
-- Index pour la table `arvie_contact_details`
--
ALTER TABLE `arvie_contact_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
...
--
-- Index pour la table `arvie_content`
--
ALTER TABLE `arvie_content`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Index pour la table `arvie_contentitem_tag_map`
--
ALTER TABLE `arvie_contentitem_tag_map`
...
--
-- Index pour la table `arvie_content_frontpage`
--
ALTER TABLE `arvie_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Index pour la table `arvie_content_rating`
--
ALTER TABLE `arvie_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Index pour la table `arvie_content_types`
--
ALTER TABLE `arvie_content_types`
  ADD PRIMARY KEY (`type_id`),
  ADD KEY `idx_alias` (`type_alias`(100));

--
-- Index pour la table `arvie_extensions`
--
ALTER TABLE `arvie_extensions`
...
--
-- Index pour la table `arvie_fields`
--
ALTER TABLE `arvie_fields`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Index pour la table `arvie_fields_categories`
--
ALTER TABLE `arvie_fields_categories`
  ADD PRIMARY KEY (`field_id`,`category_id`);

--
-- Index pour la table `arvie_fields_groups`
--
ALTER TABLE `arvie_fields_groups`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Index pour la table `arvie_fields_values`
--
ALTER TABLE `arvie_fields_values`
  ADD KEY `idx_field_id` (`field_id`),
  ADD KEY `idx_item_id` (`item_id`(191));

--
-- Index pour la table `arvie_finder_filters`
--
ALTER TABLE `arvie_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Index pour la table `arvie_finder_links`
--
ALTER TABLE `arvie_finder_links`
...
--
-- Index pour la table `arvie_finder_links_terms0`
--
ALTER TABLE `arvie_finder_links_terms0`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Index pour la table `arvie_finder_links_terms1`
--
ALTER TABLE `arvie_finder_links_terms1`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Index pour la table `arvie_finder_links_terms2`
--
ALTER TABLE `arvie_finder_links_terms2`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Index pour la table `arvie_finder_links_terms3`
--
ALTER TABLE `arvie_finder_links_terms3`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Index pour la table `arvie_finder_links_terms4`
--
ALTER TABLE `arvie_finder_links_terms4`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Index pour la table `arvie_finder_links_terms5`
--
ALTER TABLE `arvie_finder_links_terms5`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Index pour la table `arvie_finder_links_terms6`
--
ALTER TABLE `arvie_finder_links_terms6`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Index pour la table `arvie_finder_links_terms7`
--
ALTER TABLE `arvie_finder_links_terms7`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Index pour la table `arvie_finder_links_terms8`
--
ALTER TABLE `arvie_finder_links_terms8`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Index pour la table `arvie_finder_links_terms9`
--
ALTER TABLE `arvie_finder_links_terms9`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Index pour la table `arvie_finder_links_termsa`
--
ALTER TABLE `arvie_finder_links_termsa`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Index pour la table `arvie_finder_links_termsb`
--
ALTER TABLE `arvie_finder_links_termsb`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Index pour la table `arvie_finder_links_termsc`
--
ALTER TABLE `arvie_finder_links_termsc`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Index pour la table `arvie_finder_links_termsd`
--
ALTER TABLE `arvie_finder_links_termsd`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Index pour la table `arvie_finder_links_termse`
--
ALTER TABLE `arvie_finder_links_termse`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Index pour la table `arvie_finder_links_termsf`
--
ALTER TABLE `arvie_finder_links_termsf`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Index pour la table `arvie_finder_taxonomy`
--
ALTER TABLE `arvie_finder_taxonomy`
  ADD PRIMARY KEY (`id`),
...
--
-- Index pour la table `arvie_finder_taxonomy_map`
--
ALTER TABLE `arvie_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`),
  ADD KEY `link_id` (`link_id`),
  ADD KEY `node_id` (`node_id`);

--
-- Index pour la table `arvie_finder_terms`
--
ALTER TABLE `arvie_finder_terms`
...
--
-- Index pour la table `arvie_finder_terms_common`
--
ALTER TABLE `arvie_finder_terms_common`
  ADD KEY `idx_word_lang` (`term`,`language`),
  ADD KEY `idx_lang` (`language`);

--
-- Index pour la table `arvie_finder_tokens`
--
ALTER TABLE `arvie_finder_tokens`
  ADD KEY `idx_word` (`term`),
  ADD KEY `idx_context` (`context`);

--
-- Index pour la table `arvie_finder_tokens_aggregate`
--
ALTER TABLE `arvie_finder_tokens_aggregate`
  ADD KEY `token` (`term`),
  ADD KEY `keyword_id` (`term_id`);

--
-- Index pour la table `arvie_finder_types`
--
ALTER TABLE `arvie_finder_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `title` (`title`);

--
-- Index pour la table `arvie_languages`
--
ALTER TABLE `arvie_languages`
...
--
-- Index pour la table `arvie_menu`
--
...
--
-- Index pour la table `arvie_menu_types`
--
...
--
-- Index pour la table `arvie_messages`
--
ALTER TABLE `arvie_messages`
  ADD PRIMARY KEY (`message_id`),
  ADD KEY `useridto_state` (`user_id_to`,`state`);

--
-- Index pour la table `arvie_messages_cfg`
--
ALTER TABLE `arvie_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Index pour la table `arvie_modules`
--
...
--
-- Index pour la table `arvie_modules_menu`
--
ALTER TABLE `arvie_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Index pour la table `arvie_newsfeeds`
--
ALTER TABLE `arvie_newsfeeds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`published`),
...
--
-- Index pour la table `arvie_overrider`
--
ALTER TABLE `arvie_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `arvie_postinstall_messages`
--
ALTER TABLE `arvie_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Index pour la table `arvie_redirect_links`
--
ALTER TABLE `arvie_redirect_links`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_old_url` (`old_url`(100)),
  ADD KEY `idx_link_modifed` (`modified_date`);

--
-- Index pour la table `arvie_schemas`
--
ALTER TABLE `arvie_schemas`
  ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Index pour la table `arvie_session`
--
ALTER TABLE `arvie_session`
  ADD PRIMARY KEY (`session_id`),
  ADD KEY `userid` (`userid`),
  ADD KEY `time` (`time`);

--
-- Index pour la table `arvie_tags`
--
ALTER TABLE `arvie_tags`
  ADD PRIMARY KEY (`id`),
...
--
-- Index pour la table `arvie_template_styles`
--
ALTER TABLE `arvie_template_styles`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_template` (`template`),
  ADD KEY `idx_home` (`home`);

--
-- Index pour la table `arvie_ucm_base`
--
ALTER TABLE `arvie_ucm_base`
...
--
-- Index pour la table `arvie_ucm_content`
--
ALTER TABLE `arvie_ucm_content`
...
--
-- Index pour la table `arvie_ucm_history`
--
ALTER TABLE `arvie_ucm_history`
  ADD PRIMARY KEY (`version_id`),
  ADD KEY `idx_ucm_item_id` (`ucm_type_id`,`ucm_item_id`),
  ADD KEY `idx_save_date` (`save_date`);

--
-- Index pour la table `arvie_updates`
--
ALTER TABLE `arvie_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Index pour la table `arvie_update_sites`
--
ALTER TABLE `arvie_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Index pour la table `arvie_update_sites_extensions`
--
ALTER TABLE `arvie_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Index pour la table `arvie_usergroups`
--
ALTER TABLE `arvie_usergroups`
  ADD PRIMARY KEY (`id`),
...
--
-- Index pour la table `arvie_users`
--
...
--
-- Index pour la table `arvie_user_keys`
--
ALTER TABLE `arvie_user_keys`
  ADD PRIMARY KEY (`id`),
...
--
-- Index pour la table `arvie_user_notes`
--
ALTER TABLE `arvie_user_notes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`),
  ADD KEY `idx_category_id` (`catid`);

--
-- Index pour la table `arvie_user_profiles`
--
ALTER TABLE `arvie_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Index pour la table `arvie_user_usergroup_map`
--
ALTER TABLE `arvie_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Index pour la table `arvie_viewlevels`
--
ALTER TABLE `arvie_viewlevels`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT pour la table `arvie_annuaire_civilites`
--
ALTER TABLE `arvie_annuaire_civilites`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT pour la table `arvie_annuaire_contacts`
--
ALTER TABLE `arvie_annuaire_contacts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `arvie_annuaire_entreprises`
--
ALTER TABLE `arvie_annuaire_entreprises`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT pour la table `arvie_annuaire_pays`
--
ALTER TABLE `arvie_annuaire_pays`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT pour la table `arvie_annuaire_typescontacts`
--
ALTER TABLE `arvie_annuaire_typescontacts`
...
--
-- AUTO_INCREMENT pour la table `arvie_banner_clients`
--
ALTER TABLE `arvie_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `arvie_categories`
--
ALTER TABLE `arvie_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT pour la table `arvie_contact_details`
--
ALTER TABLE `arvie_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `arvie_content`
--
ALTER TABLE `arvie_content`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT pour la table `arvie_content_types`
--
ALTER TABLE `arvie_content_types`
  MODIFY `type_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT pour la table `arvie_extensions`
--
ALTER TABLE `arvie_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10004;

--
-- AUTO_INCREMENT pour la table `arvie_fields`
--
ALTER TABLE `arvie_fields`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `arvie_fields_groups`
--
ALTER TABLE `arvie_fields_groups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `arvie_finder_filters`
--
ALTER TABLE `arvie_finder_filters`
  MODIFY `filter_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `arvie_finder_links`
--
ALTER TABLE `arvie_finder_links`
  MODIFY `link_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `arvie_finder_taxonomy`
--
ALTER TABLE `arvie_finder_taxonomy`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `arvie_finder_terms`
--
ALTER TABLE `arvie_finder_terms`
  MODIFY `term_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `arvie_finder_types`
--
ALTER TABLE `arvie_finder_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `arvie_languages`
--
ALTER TABLE `arvie_languages`
...
--
-- AUTO_INCREMENT pour la table `arvie_overrider`
--
ALTER TABLE `arvie_overrider`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';

--
-- AUTO_INCREMENT pour la table `arvie_postinstall_messages`
--
ALTER TABLE `arvie_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT pour la table `arvie_redirect_links`
--
ALTER TABLE `arvie_redirect_links`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `arvie_tags`
--
ALTER TABLE `arvie_tags`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `arvie_template_styles`
--
ALTER TABLE `arvie_template_styles`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT pour la table `arvie_ucm_content`
--
ALTER TABLE `arvie_ucm_content`
  MODIFY `core_content_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `arvie_ucm_history`
--
ALTER TABLE `arvie_ucm_history`
  MODIFY `version_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT pour la table `arvie_updates`
--
ALTER TABLE `arvie_updates`
  MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;

--
-- AUTO_INCREMENT pour la table `arvie_update_sites`
--
ALTER TABLE `arvie_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `arvie_usergroups`
--
ALTER TABLE `arvie_usergroups`
...
--
-- AUTO_INCREMENT pour la table `arvie_user_notes`
--
ALTER TABLE `arvie_user_notes`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `arvie_viewlevels`
--
ALTER TABLE `arvie_viewlevels`
...
--
-- Contraintes pour la table `arvie_annuaire_contacts`
--
ALTER TABLE `arvie_annuaire_contacts`
  ADD CONSTRAINT `fk_arvie_annuaire_civilites_id` FOREIGN KEY (`civilites_id`) REFERENCES `arvie_annuaire_civilites` (`id`),
  ADD CONSTRAINT `fk_arvie_annuaire_entreprises_id` FOREIGN KEY (`entreprises_id`) REFERENCES `arvie_annuaire_entreprises` (`id`),
  ADD CONSTRAINT `fk_arvie_annuaire_typescontacts_id` FOREIGN KEY (`typescontacts_id`) REFERENCES `arvie_annuaire_typescontacts` (`id`);

--
-- Contraintes pour la table `arvie_annuaire_entreprises`
--
ALTER TABLE `arvie_annuaire_entreprises`
  ADD CONSTRAINT `fk_arvie_annuaire_pays_id` FOREIGN KEY (`pays_id`) REFERENCES `arvie_annuaire_pays` (`id`);
