...
class ArvieModelAbonnements extends JModelList
{
	...
	protected function _getListQuery()
	{
		...
		$query->select('a.id, a.abonne, a.suivi, a.date, a.alias, a.published, a.created, a.created_by, a.hits, a.modified, a.modified_by');
		$query->from('#__arvie_abonnement a');

		// joint la table utilisateurs
		$query->select('a.abonne AS utlisateur')->join('LEFT', '#__arvie_utilisateurs AS u ON u.nom=a.abonne');
		...
		// tri des colonnes
		$orderCol = $this->getState('list.ordering', 'abonne');
